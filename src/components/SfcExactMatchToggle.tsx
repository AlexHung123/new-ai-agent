    ...
    >
      <div className="inline-flex rounded-md shadow-sm" role="group">
        <button
          ...
          className={`px-3 py-1.5 text-xs font-medium border rounded-s-lg transition-colors ${
            sfcExactMatch
        ...
        <button
          ...
          className={`px-3 py-1.5 text-xs font-medium border border-s-0 rounded-e-lg transition-colors ${
            !sfcExactMatch
              ? 'bg-[#24A0ED] text-white border-[#24A0ED]'
              : 'bg-transparent text-[#24A0ED] border-[#24A0ED] hover:bg-[#24A0ED]/10'
          }`}
